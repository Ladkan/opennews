...
migrate((app) => {
  ...
  // remove field
  collection.fields.removeById("_clone_M57p")

  // remove field
  collection.fields.removeById("_clone_MYOa")

  // remove field
  collection.fields.removeById("_clone_7Jfl")

  // remove field
  collection.fields.removeById("_clone_ResT")

  // remove field
  collection.fields.removeById("_clone_VFZR")

  // remove field
  collection.fields.removeById("_clone_2Xu4")

  // remove field
  collection.fields.removeById("_clone_U4L2")
